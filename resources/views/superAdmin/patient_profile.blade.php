                ...
                <div class="cards">
                    <div class="card card-3">
                        <div class="card-data">
                            ...
                            <p>
                            <p card--title>Email: {{ $pro->email }}</p>
                            <p card--title>Address: {{ $pro->address }}</p>
                            <p card--title>Mobile: {{ $pro->phone_number }}</p>
                        </div>
                    ...
                    <div class="card card-4">
                        <div class="card-data">
                            <div class="card-content">
                                <p class="card--title">Weight: {{$profile->weight}}</p>
                                <p class="card--title">Height: {{$profile->height}}</p>
                                <p class="card--title">Blood: {{$profile->blood_group}}</p>
